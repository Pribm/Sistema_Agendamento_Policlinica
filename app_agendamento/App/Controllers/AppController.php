...
class AppController extends Action{
    ...
    public function navCadastraFuncionario(){
        $this->validaAutenticacao();
        $funcionarios = Container::getModel('Usuario');
        ...
        $this->view->funcionarios = $funcionarios->listaFuncionarios();
    ...
    public function horariosDeAtendimentos(){
        //FAZ UMA CONSULTA E RETORNA TODOS OS HORÁRIOS DE ATENDIMENTOS DOS FUNCIONÁRIOS
        $horarios = Container::getModel('Horario');
        echo json_encode($horarios->read());
    }
